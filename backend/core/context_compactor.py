...
class ContextCompactor:
    ...
    def compact_history(
        ...
        the most recent `verbatim_turns` turns completely verbatim.
        """
        if not history:
            return ""
        ...
        for h in older_turns[-8:]:
            ...
            if a:
                # Condense code blocks in older turns to conserve space
        ...
        return f"{capsule_header}PERCAKAPAN TERBARU:\n" + "\n---\n".join(recent_lines) + "\n\n"
