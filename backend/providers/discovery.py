    ...
    live_models = [
        {
            ...
            "badge": "Live Audio",
            "description": "Audio dua arah real-time super cepat generasi 3.1 dengan ekspresi suara alami.",
            "icon": "gemini",
            "supports_voice": True,
        },
        {
            ...
            "category": "voice_native",
            "badge": "Live Audio",
            "description": "Audio lisan streaming dua arah stabil generasi 2.5 berlatensi rendah.",
            "icon": "gemini",
            "supports_voice": True,
        },
        {
            ...
            "category": "voice_native",
            "badge": "Live Audio",
            "description": "Audio lisan bidi klasik generasi 2.0.",
            "icon": "gemini",
            "supports_voice": True,
        },
    ]
...
async def fetch_codex_models(force_refresh: bool = False) -> List[Dict[str, Any]]:
    ...
    fetch_ok = False
    codex_defaults = [
        ("codex/o3-mini", "OpenAI o3-mini (Codex Reasoning)", "High Reasoning", "Model penalaran coding & logika generasi terbaru dengan kecerdasan tingkat tinggi."),
        ("codex/o1", "OpenAI o1 (Codex Deep)", "Deep Reasoning", "Model deep reasoning OpenAI untuk penalaran arsitektur dan algoritma kompleks."),
        ("codex/o1-mini", "OpenAI o1-mini (Codex Fast)", "Fast Reasoning", "Versi penalaran cepat o1 untuk pembuatan skrip dan optimasi kode."),
        ("codex/gpt-4o", "GPT-4o Omnimodal", "Omnimodal", "Model flagship multimodal OpenAI dengan kecepatan tinggi dan penalaran luas."),
        ("codex/gpt-4o-mini", "GPT-4o Mini", "Fast General", "Model efisien super cepat untuk tugas coding harian dan analisis teks."),
        ("codex/chatgpt-4o-latest", "ChatGPT-4o Dynamic", "Flagship", "Model riset dinamis ChatGPT-4o terbaru."),
        ("codex/gpt-5.3-codex", "OpenAI Codex 5.3", "Code & Logic", "Model resmi Codex CLI untuk pembuatan skrip, arsitektur, dan eksekusi coding."),
    ]
                ...
                if res.status_code == 200:
                    ...
                    for item in data:
                        ...
                        models_list.append({
                            ...
                            "category": category,
                            "badge": badge,
                            "description": f"Model resmi OpenAI {raw_id}.",
                            "icon": "openai",
                            "supports_voice": False,
                            "supports_text": True,
                        })
                ...
                if res.status_code == 200:
                    ...
                    for item in data:
                        ...
                        models_list.append({
                            ...
                            "category": category,
                            "badge": badge,
                            "description": f"Model resmi Anthropic: {disp_name}.",
                            "icon": icon,
                            "supports_voice": True,
                        })
            fetch_ok = True
    ...
    if not models_list and anthropic_key:
        ...
        for mid, mname, mbadge in anthropic_defaults:
            models_list.append({
                ...
                "badge": mbadge,
                "description": "Akses resmi Anthropic API menggunakan key sk-ant-...",
                "icon": "anthropic",
                "supports_voice": True,
            })
        fetch_ok = True
    ...
    async def _fetch_one(node: Dict[str, Any]) -> List[Dict[str, Any]]:
                    ...
                    for item in (raw_data or []):
                        ...
                        if m_id:
                            ...
                            discovered.append({
                                ...
                                "category": cat,
                                "badge": node["name"],
                                "description": f"Model kustom via {node['name']} ({base_url})",
                                "icon": "custom",
                                "supports_voice": False,
                                "supports_text": True,
                            })
        ...
        if not discovered and node.get("default_model"):
            ...
            discovered.append({
                ...
                "category": cat,
                "badge": node["name"],
                "description": f"Model kustom default via {node['name']}",
                "icon": "custom",
                "supports_voice": False,
                "supports_text": True,
            })
