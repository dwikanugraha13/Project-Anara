...
```bash
S=~/.anara/skills/research/grounded-citations/scripts/sources.py
...
`anara skills install official/social-media/reddit-reading` or
`anara skills install official/research/rss-feeds` before using them.
