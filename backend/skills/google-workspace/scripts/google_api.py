#!/usr/bin/env python3
"""Google Workspace API CLI for Anara Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Anara-facing JSON contract and falls back to the Python client
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Anara Agent")
